...
def hello_world():
    ...
    if request.method == 'POST':
        ...
        if predictedclass[0] == 1:
            return render_template('Result.html', predictedclasssend=predictedclassres, predictedprob=round(proba*100, 2), placed=True)

        else:
            return render_template('Result.html', predictedclasssend=predictedclassres)
